...
public class UiLifecycleHelper {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.v(getClass().getName(),"Coming inside onCreate of UIHELPER: "+ session);
        if (session == null) {
            if (savedInstanceState != null) {
                Log.v(getClass().getName(),"Coming inside savedInstanceState is not null but session is");
        ...
        if (savedInstanceState != null) {
            Log.v(getClass().getName(),"Coming inside savedInstanceState");
